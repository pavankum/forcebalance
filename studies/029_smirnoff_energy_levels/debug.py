...
def Run_ForceBalance(input_file='./optimize.in', debug=False, continue_=False):
...
"""
    ...
    Run_ForceBalance('./optimize.in') #, debug=args.debug, continue_=continue_)
